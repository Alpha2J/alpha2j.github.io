...
1. Who's it for?
   - stands for the "International English Language Testing System", and it's a test of English proficiency for people whose mother tongue is not English.

1. What does it look like exactly?
   - The test has two modules, including the Academic IELTS or the General IELTS.
   - Academic IELTS: It's the suitable one for who 
   - Which one is right for me: 
2. How do I pass?
3. How do I prepare for IELTS?
4. How do I even book the test?



questions:

1. Do I need british English for IELTS?
   - No. IELTS is owned by three partner organizations. Cambridge English, who write the test. and IDP and the British Council, who deliver the test.
   - When you are writing, you can use American spelling or British spelling, make sure you choose one, don't mix them.
   - In the speaking test, you can speak with an American accent, a British accent, a local accent.It doesn't matter. Accent is not evaluated in the test, but pronumciation yes.
   - In the listening test, you will be test on your ability to understand speakers of many countries, like South Africa or Australia, Ireland, the United States and so on.

2. Which is easier, IDP or the British Council?
   - Where you go, IDP or the British Council, it doesn't matter, it's the same. The Cambridge English write the test.
